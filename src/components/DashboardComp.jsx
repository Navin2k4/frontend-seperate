...
import { Button, Table, TableCell, TableHead } from "flowbite-react";
      ...
      <div className="flex-wrap mt-5 flex gap-4 justify-center">
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-lg shadow-md">
          <div className="flex justify-between">
            ...
            <HiAnnotation className="bg-violet-600 text-white rounded-full text-5xl p-2 shadow-lg" />
          </div>
          <div className="flex gap-2 text-sm">
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-lg shadow-md">
          <div className="flex justify-between">
            ...
            <HiDocumentText className="bg-yellow-600 text-white rounded-full text-5xl p-2 shadow-lg" />
          </div>
          <div className="flex gap-2 text-sm">
